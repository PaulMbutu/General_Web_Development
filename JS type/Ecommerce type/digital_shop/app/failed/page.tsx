...
const page = () => {
  return (
    <section className='bg-linear-to-br from-red-50 to-red-100 px-6 py-20 text-center'>
        <div className='max-w-3xl mx-auto space-y-8'>
            ...
            <div className='flex flex-col sm:flex-row justify-center gap-4 pt-4'>
                <Link href="/checkout"
                    className='inline-block px-6 py-3 rounded-full bg-red-600 text-white text-base font-medium'
                >
                 Try Again
                </Link>
                <Link href="/contact"
                    className='inline-block px-6 py-3 rounded-full bg-black text-white text-base font-medium hover:bg-gray-50'
                >
                 Contact Support
                </Link>
            </div>
