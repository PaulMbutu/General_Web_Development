...
const CategoryBtn = ({cat}:{cat: Category}) => {
  ...
  console.log("pathname ",pathName," btnPath ",btnPath)
  console.log()
  return (
    <Link href={`/categories/${cat.slug}`}>
      <button className={cn("cat-btn cursor-pointer", pathName == btnPath ? "bg-black": " bg-linear-to-r from-gray-100 to-gray-200")}>
        {/* Icon Container */}
